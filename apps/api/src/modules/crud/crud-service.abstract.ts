...
import { CrudRepository } from './repositories/crud-repository.abstract';
import { FindManyOptions, FindOneOptions, In } from 'typeorm';

export abstract class CrudService<Entity> implements CrudServiceInterface<Entity, number> {
  constructor(private readonly repository: CrudRepository<Entity>) {}
  ...
  async softDeleteById(id: number): Promise<boolean> {
    ...
    // await this.update(id, { [DATABASE_IS_DELETED_FIELD_NAME]: true });
